...
#'
#'
#' hprdata<- function(hprfile,n,...){
#'   hprfile <- list.files(hprfile, pattern = '.hpr', ...)[n]
...
#' return(hprdataMap)}
#'
#' temp <- hpr_iterator(lfiles,recursive = TRUE, full.names= TRUE)
#'
#'
#' hpr_iterator0 <- function(hprfile,y = 1, ...){
#'   hprfile <- list.files(hprfile, ...)
#'   hprdataMap <- Map(function(x)
#'     hprdata0(hprfile[x]), y)
#'   return(hprdataMap)}
#'
#'
#' tmp <- hpr_iterator0(lfiles, 1:2, recursive = TRUE, full.names= TRUE)
#'
