...
#' @return A list of data.frames: stems, products, logs, machinereport_meta, operators, objects, stem_grades, pricematrixes, stemdiametervectors, and stemtypes.
#' @export
#'
#' @examples
...
#' hprtests <- purrr::map_dfr(hprfiles, ~tibble::tibble(filename = .x, hprdata = list(hprdata(.x))))
